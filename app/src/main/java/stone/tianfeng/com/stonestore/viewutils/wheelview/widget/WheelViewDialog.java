 ...
 */
package stone.tianfeng.com.stonestore.viewutils.wheelview.widget;
...
import stone.tianfeng.com.stonestore.viewutils.wheelview.adapter.ArrayWheelAdapter;
import stone.tianfeng.com.stonestore.viewutils.wheelview.common.WheelConstants;
import stone.tianfeng.com.stonestore.viewutils.wheelview.util.WheelUtils;
import stone.tianfeng.com.stonestore.viewutils.wheelview.widget.*;
...
public class WheelViewDialog<T> implements View.OnClickListener {
    ...
    private stone.tianfeng.com.stonestore.viewutils.wheelview.widget.WheelView<T> mWheelView;

    private stone.tianfeng.com.stonestore.viewutils.wheelview.widget.WheelView.WheelViewStyle mStyle;
    ...
    private void init() {
        ...
        mWheelView = new stone.tianfeng.com.stonestore.viewutils.wheelview.widget.WheelView(mContext);
        mWheelView.setSkin(stone.tianfeng.com.stonestore.viewutils.wheelview.widget.WheelView.Skin.Holo);
        mWheelView.setWheelAdapter(new ArrayWheelAdapter(mContext));
        mStyle = new stone.tianfeng.com.stonestore.viewutils.wheelview.widget.WheelView.WheelViewStyle();
        mStyle.textColor = Color.GRAY;
        mStyle.selectedTextZoom = 1.2f;
        mWheelView.setStyle(mStyle);

        mWheelView.setOnWheelItemSelectedListener(new stone.tianfeng.com.stonestore.viewutils.wheelview.widget.WheelView.OnWheelItemSelectedListener<T>() {
            @Override
