...
public class PullToFootRefreshView extends LinearLayout
{
	...
	public PullToFootRefreshView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init();
	}

	public PullToFootRefreshView(Context context)
	{
		super(context);
		init();
	}
