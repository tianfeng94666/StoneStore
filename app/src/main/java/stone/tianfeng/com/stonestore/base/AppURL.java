...
//    static String QxVersion = "QxVersion="+ ""+"&";
    static String QxVersion = "QxVersion=1.7" + "&";
    /*"http://192.168.1.240:9112/api/Aproxy/*/
    private static String baseHost = "http://appapi2.fanerweb.com/api/";
    private static String baseUrl = baseHost + "aproxy/";
    /**
     * 支付接口base
     */
    private static String basePayUrl = baseHost + "Payment/";
   ...
   /*当前订单*/
    ...
    public static String URL_STONE_SEARCHINFO = baseUrl + "stoneSearchInfo?" + QxVersion;
    ...
    /**
     * 支付宝回调接口
     * http://appapi2.fanerweb.com/api/Payment/ReceiveAilpayNotice
     */
    public static String URL_PAY_ALIPAY = basePayUrl + "ReceiveAilpayNotice?" + QxVersion;
    /**
     * 订单支付宝回调接口
     * http://appapi2.fanerweb.com/api/Payment/GetAilpayPayStr?tokenKey=69a875e5c234b5b49d1bead689f84832
     */
    public static String URL_GETAILPAY = basePayUrl + "GetAilpayModelOrderPayStr?" + QxVersion;
    /**
     * 获取微信支付数据接口
     * http://appapi1.fanerweb.com/api/Payment/ReceiveAilpayNotice
     */
    public static String URL_PAY_WEIXIN = basePayUrl + "GetWxpayModelParameter?" + QxVersion;
    /**
     * 石头确认下单
     */
     ...
     * 石头订单支付宝回调接口
     */
    public static String URL_GET_STONE_AILPAY = basePayUrl + "GetAilpayStoneOrderPayStr?" + QxVersion;
    /**
     * 石头订单微信回调接口
     */
    public static String URL_GET_STONE_WEIXIN = basePayUrl + "GetWxpayStoneParameter?" + QxVersion;
    /**
     * 取消石头代付款订单
     */
     ...
     */
    public static String URL_QUICK_MAKING = baseUrl + "OrderCurrentDoModelItemForDefaultNowDo?" + QxVersion;
    /**
     * 获得快速定制历史订单
     */
    public static String URL_QUICK_MAKING_LIST = baseUrl + "OrderListNowPage?" + QxVersion;
    /**
     * 编辑历史订单
     */
    public static String URL_QUICK_MAKING_EDIT = baseUrl + "OrderCurrentEditModelItemForDefaultNowDo?" + QxVersion;
    /**
     * 快速定制提交订单
     * OrderCurrentSubmitNowDo
     */
    public static String URL_ORDER_SUBMIT_QUICK = baseUrl + "OrderCurrentSubmitNowDo?" + QxVersion;
}
